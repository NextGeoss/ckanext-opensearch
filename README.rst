...
3. Add ``opensearch`` to the ``ckan.plugins`` setting in your CKAN
...
Document any optional config settings here. For example::
    ...
    # (optional, default: 24).
    ckanext.opensearch.some_setting = some_default_value
...
---------------------------------
Registering ckanext-opensearch on PyPI
---------------------------------

ckanext-opensearch should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-opensearch. If that link doesn't work, then
...
----------------------------------------
Releasing a New Version of ckanext-opensearch
----------------------------------------

ckanext-opensearch is availabe on PyPI as https://pypi.python.org/pypi/ckanext-opensearch.
